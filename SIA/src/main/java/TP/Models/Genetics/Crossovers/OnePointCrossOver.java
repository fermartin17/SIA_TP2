...
public class OnePointCrossOver implements ICrossover {
    ...
    public Chromosome[] cross(Chromosome p1, Chromosome p2) {
        ...
        return cross(p1, p2, ThreadLocalRandom.current().nextInt(0, Chromosome.S + 1));
    }
    ...
    public Chromosome[] cross(Chromosome p1, Chromosome p2, int n) {
        ...
        System.arraycopy(p2.getChromosome(), n, children[0].getChromosome(), n, Chromosome.S - n);
        System.arraycopy(p1.getChromosome(), n, children[1].getChromosome(), n, Chromosome.S - n);
        return children;
    }
}
